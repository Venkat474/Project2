...
<br>**`Go to MobaXterm`** ➡️ Session ➡️ SSH ➡️ Remotehost-pasteIPV4 ➡️ [✔] Specify username-*ec2-user* ➡️ Advanced SSH Settings ➡️ [✔]Use private key-Provide private key from downloads ➡️ OK    
<br>*Now we need to change the hostname of the server using below link*
